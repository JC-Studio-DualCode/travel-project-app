...
import { FiMapPin, FiDatabase, FiGitBranch, FiChevronRight, FiHome } from "react-icons/fi";
    ...
    <div className={styles.pageBg}>
      <div className={styles.about}>
        <nav className={styles.breadcrumbs} aria-label="Breadcrumb">
          <Link className={styles.crumbLink} to="/">Home</Link>
          <span className={styles.crumbSep} aria-hidden="true"><FiChevronRight /></span>
        ...
        <section className={styles.aboutGrid}>
          ...
          <div className={styles.aboutCard}>
            <div className={styles.iconBadge}><FiGitBranch size={22} /></div>
            <h3>CRUD Features</h3>
